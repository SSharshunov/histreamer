...
#if defined(PJMEDIA_HAS_VIDEO) && PJMEDIA_HAS_VIDEO != 0 && \
    !defined(PJMEDIA_HAS_H264_HISILICON_PASSTHROUGH_VID_CODEC) || PJMEDIA_HAS_H264_HISILICON_PASSTHROUGH_VID_CODEC != 1
         ...
         if (status != PJ_SUCCESS)
             goto on_error;
#endif    /* PJMEDIA_HAS_H264_HISILICON_PASSTHROUGH_VID_CODEC */
